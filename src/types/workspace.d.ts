...
import type { CoverageItem, InterviewGuide, InterviewMaterial, StructuredInterviewNotes } from './interview';
import type { OpportunityMap } from './opportunityMap';
import type { PainPoint } from './painPoint';
import type { Project } from './project';
import type { DepartmentQuestionnaireSummary, QuestionnaireRecord } from './questionnaire';
...
export declare const createEmptyWorkspaceState: () => WorkspaceState;
